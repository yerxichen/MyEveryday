...
public class CustomDialogToast extends Dialog {
	...
	public CustomDialogToast(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public CustomDialogToast create() {
			LayoutInflater inflater = (LayoutInflater) context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			// instantiate the dialog with the custom Theme
			final CustomDialogToast dialog = new CustomDialogToast(context, R.style.Dialog);
			View layout = inflater.inflate(R.layout.dialog_normal_layout_toast, null);
